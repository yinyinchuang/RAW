...
<head>
    ...
    <style>
        ...
        .add_new_card_content::-webkit-scrollbar {
            display: none;
        }
    </style>
</head>
...
<div class="container twosides_container">
    ...
    <div class="member_right_sidebar">
        ...
        <div class="add_new_card">
            <div class="add_new_card_photo">
                <div class="the_add_photo">
                    <img src="./img/uploadpic.png" id="add-upload-img">
                </div>
        ...
        <!-- cards -->
        <div class="cards right_cards wish_h">
            <?php
            //預設訊息
            // $obj['success'] = false;
...
<script>
    ...
    $('button#add_new_card_save').click(function() {
        ...
        // let objUser = {
        //     myFile: my_file,
        //     cardContent: text_cardContent.val()
        // };

        // //送出 post 請求，
        // $.post("uploadNewCard.php", form_data, function(obj) {
        //     if (obj['success']) {
        //         //關閉 modal
